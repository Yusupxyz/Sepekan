...
<body>
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
            <!-- <form action="<?php echo base_url().'sales/penjualan_kredit/add_to_cart'?>" method="post">
            <table>
                <tr>
                    <th>Kode Barang</th>
                </tr>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                ...
                <tbody>
                    ...
                    <tr>
                         ...
                         <td style="text-align:center;"><a href="<?php echo base_url().'sales/penjualan_kredit/remove/'.$items['rowid'];?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                    </tr>
            ...
            <form action="<?php echo base_url().'sales/penjualan_kredit/simpan_penjualan'?>" method="post">
            <table>
                <tr>
                    <td style="width:760px;" rowspan="2"><button type="submit" class="btn btn-info btn-lg"> Lanjut</button></td>
   ...
   ?> 
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#kode_brg").on("input",function(){
                var kobar = {kode_brg:$(this).val()};
                   $.ajax({
               type: "POST",
               url : "<?php echo base_url().'sales/penjualan_kredit/get_barang';?>",
               data: kobar,
        ...
        function add(id,stok,harga) {
            $.ajax({
                url: "<?php echo base_url().'sales/penjualan_kredit/add_to_cart' ?>",
                type: "post",
