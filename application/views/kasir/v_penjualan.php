   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="<?php echo base_url().'kasir/penjualan/simpan_penjualan'?>" method="post">
            <table>
                <tr>
                    <td style="width:760px;" rowspan="2"><button type="submit" class="btn btn-info btn-lg"> Bayar</button></td>
                    <th style="width:140px;">Total Belanja(Rp)</th>
                    <th style="text-align:right;width:140px;"><input type="text" name="total2" value="<?php echo number_format($total);?>" class="form-control input-sm" style="text-align:right;margin-bottom:5px;" readonly></th>
        ...
        <form action="<?php echo base_url().'kasir/penjualan/'?>" method="post">
   ...
   ?> 
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#kode_brg").on("input",function(){
                var kobar = {kode_brg:$(this).val()};
                   $.ajax({
               type: "POST",
               url : "<?php echo base_url().'kasir/penjualan/get_barang';?>",
               data: kobar,
        ...
        function add(id,stok,harga) {
            $.ajax({
                url: "<?php echo base_url().'kasir/penjualan/add_to_cart' ?>",
                type: "post",
