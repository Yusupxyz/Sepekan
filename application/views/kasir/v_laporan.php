   ...
   ?>
    ...
    <div class="container">
                ...
                <tbody>
                    ...
                    <!-- <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'kasir/data_penjualan/lap_data_penjualan'?>" target="_blank"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr> -->

                    <tr>
                        <td style="text-align:center;vertical-align:middle">1</td>
                        <td style="vertical-align:middle;">Data Penjualan PerTanggal</td>
                        <td style="text-align:center;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Data Penjualan PerBulan</td>
                        <td style="text-align:center;">
                    ...
                    <tr>
                        <td style="text-align:center;vertical-align:middle">3</td>
                        <td style="vertical-align:middle;">Data Penjualan PerTahun</td>
                        <td style="text-align:center;">
        ...
        <div class="modal fade" id="lap_jual_pertanggal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'kasir/data_penjualan/lap_penjualan_pertanggal'?>" target="_blank">
        ...
        <div class="modal fade" id="lap_jual_perbulan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'kasir/data_penjualan/lap_penjualan_perbulan'?>" target="_blank">
                <div class="modal-body">
        ...
        <div class="modal fade" id="lap_jual_pertahun" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'kasir/data_penjualan/lap_penjualan_pertahun'?>" target="_blank">
                <div class="modal-body">
